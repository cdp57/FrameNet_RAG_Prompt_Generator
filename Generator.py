...
FE_def_list = ["A quantity or other characterization of the Entity's age.",'The feature of an Entity which is a function of the amount of time that the Entity has existed.','A modifier expressing the deviation of the Age from the norm.','The Entity for which a particular age is under consideration.','The Frame Element Expressor marks expressions that indicate a body part, gesture or other expression of the Entity that reflect its age.']
core_count = 5
inherits_from_list = ["Measurable_attributes"]
inherited_by_list = []
perspective_on_list = []
is_perspectivized_in_list = []
uses_list = []
is_used_by_list = ["Aging","People_by_age"]
subframe_of_list = []
has_subframe_list = []
precedes_list = []
is_preceded_by_list = []
